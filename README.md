...
| 2026-06 | TurkicOCR-Cyrillic | [TurkicOCR synthetic Cyrillic dataset (dataset card)](https://huggingface.co/datasets/alenisaw/turkicocr-cyrillic) | [Files](https://huggingface.co/datasets/alenisaw/turkicocr-cyrillic/tree/main) | 66.7 GB (62.2 GiB) | 100,000 unique pages; 175,000 nested-config rows | OCR / Layout analysis / VDU |
