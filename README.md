...
| 6 | 2026-04 | **[PersonaMix](https://huggingface.co/datasets/issai/PersonaMix)**<br><sub>ISSAI researchers</sub><br><sub>Open</sub> | Target-speaker ASR | Controlled Kazakh-English overlapping-speech benchmark for target-speaker ASR and target-presence detection. | Not reported | 9,978 mixtures |
...
| 8 | 2026-03 | **[WavCaps Kazakh/Russian](https://huggingface.co/datasets/issai/WavCaps_Kazakh_Russian)**<br><sub>ISSAI researchers</sub><br><sub>Open</sub> | Audio captioning | Machine-translated Kazakh and Russian WavCaps test set for free-form captioning of environmental audio and sound scenes. | Not reported | 3,460 rows |
...
| 7 | 2026-03 | **[BabyVision Kazakh](https://huggingface.co/datasets/issai/BabyVision_Kazakh)**<br><sub>ISSAI researchers</sub><br><sub>Open</sub> | Visual question answering | Machine-translated Kazakh BabyVision benchmark for child-intuitive visual perception, counting, shape recognition, and anomaly detection. | Not reported | 388 rows |
...
| 13 | 2025-12 | **[MMStar Kazakh/Russian](https://huggingface.co/datasets/issai/MMstar_Kazakh_Russian)**<br><sub>ISSAI researchers</sub><br><sub>Open</sub> | Visual question answering | Machine-translated Kazakh and Russian MMStar benchmark for visual recognition and multimodal reasoning across 18 dimensions. | Not reported | 3,000 rows |
| 14 | 2025-12 | **[RealWorldQA Kazakh/Russian](https://huggingface.co/datasets/issai/RealWorldQA_Kazakh_Russian)**<br><sub>ISSAI researchers</sub><br><sub>Open</sub> | Visual question answering | Machine-translated Kazakh and Russian RealWorldQA benchmark for spatial understanding and reasoning over real-world images. | Not reported | 1,530 rows |
...
<tr><td align="center" valign="middle"><strong>T2I</strong> — Cultural vision benchmark (text-to-image)</td><td align="center" valign="middle"><strong>Target-speaker ASR</strong> — Target-speaker ASR</td><td align="center" valign="middle"><strong>TC</strong> — Text classification</td><td align="center" valign="middle"><strong>TS-ASR</strong> — Target-speaker ASR / speech separation</td><td align="center" valign="middle"><strong>TTS</strong> — Text-to-speech (TTS)</td><td align="center" valign="middle"><strong>Visual question answering</strong> — Visual question answering</td></tr>
<tr><td align="center" valign="middle"><strong>VMR</strong> — Visual math reasoning</td><td align="center" valign="middle"><strong>VQA</strong> — Visual QA</td><td align="center" valign="middle"><strong>VSR</strong> — Visual speech recognition (lip reading)</td><td align="center" valign="middle"></td><td align="center" valign="middle"></td><td align="center" valign="middle"></td></tr>
</table>
<!-- ABBREVIATIONS:END -->
